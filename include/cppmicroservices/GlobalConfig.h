...
#define CppMicroServices_VERSION_MINOR 2
#define CppMicroServices_VERSION_PATCH 0
#define CppMicroServices_VERSION 3.2.0
#define CppMicroServices_VERSION_STR "3.2.0"

#define US_VERSION_MAJOR 3
#define US_VERSION_MINOR 2
#define US_VERSION_PATCH 0
#define US_VERSION 3.2.0
#define US_VERSION_STR "3.2.0"
...
#define US_LIB_PREFIX ""
#define US_LIB_EXT ".dll"
#define US_EXE_EXT ".exe"
