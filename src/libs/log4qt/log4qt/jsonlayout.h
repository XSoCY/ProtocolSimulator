...
namespace Log4Qt
{
    ...
    /*!
     * \brief The class JSONLayout outputs the time, thread, logger and nested
     *        diagnostic context information of a logging event.
     *
     * \note The ownership and lifetime of objects of this class are managed.
     *       See \ref Ownership "Object ownership" for more details.
     */
class LIBLOG4QTSHARED_EXPORT JSONLayout : public Layout
{
    Q_OBJECT
...
protected:
     ...
     *
     * <tt>
     * %JSONLayout(name:"TTCC" categoryprefixing:true
...
inline QString JSONLayout::contentType() const
{
    return QString::fromLatin1("text/json");
}

inline bool JSONLayout::categoryPrefixing() const
{	return mCategoryPrefixing;	}

inline bool JSONLayout::contextPrinting() const
{	return mContextPrinting;	}

inline bool JSONLayout::threadPrinting() const
{	return mThreadPrinting;	}

inline void JSONLayout::setCategoryPrefixing(bool categoryPrefixing)
{	mCategoryPrefixing = categoryPrefixing;
}

inline void JSONLayout::setContextPrinting(bool contextPrinting)
{	mContextPrinting = contextPrinting;
}

inline void JSONLayout::setThreadPrinting(bool threadPrinting)
...
// Q_DECLARE_TYPEINFO(Log4Qt::JSONLayout, Q_COMPLEX_TYPE); // Use default
