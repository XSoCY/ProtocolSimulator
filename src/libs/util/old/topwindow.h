...
public:
     ...
     */
    explicit TopWindow(QWidget* centralWidget, const QMargins& windowPaddings = QMargins(16, 10, 16, 16),
        const QMargins& borderImageBorders = QMargins(23, 13, 23, 33), const QString& borderImagePath = QString("://images/shadow.png"),
        bool borderImageHorizontalStretch = true, bool borderImageVerticalStretch = true);
    ~TopWindow();
     ...
     * @brief 是否需要绘制背景
     */
    bool needDrawBG() const
    {
        return m_needDrawBG;
    }
    void setNeedDrawBG(bool val)
    {
        m_needDrawBG = val;
    }
signals:
