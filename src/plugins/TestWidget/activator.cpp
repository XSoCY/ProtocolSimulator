 ...
 */
class US_ABI_LOCAL TestWidgetActivator : public BundleActivator
{
...
private:
    ...
    {
    public:
        GuiImpl(BundleContext context) : context_(context) {}
        virtual ~GuiImpl() {}

        virtual QWidget *createWidget(QWidget *parent = nullptr)
        {
            return new Dialog(context_, parent);
        }
...
public:
    ...
    void Start(BundleContext context)
    {
        ...
        props["Type"] = std::string("TestWidget");
...
CPPMICROSERVICES_EXPORT_BUNDLE_ACTIVATOR(TestWidgetActivator)
//![Activator]
